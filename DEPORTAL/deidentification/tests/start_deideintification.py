...
def test_deid_state():
    client_obj = Clients.objects.get(client_name="test_local_1")
    #client_obj.config['admin_connection_str'] = 'mysql+mysqlconnector://ndadmin:ndADMIN%402025@localhost:3306/dump_07102025'
    #client_obj.save()
    ...
    endpoint = reverse("start_whole_identification", kwargs={"dump_id": dump_obj.id})
