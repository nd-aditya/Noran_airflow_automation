...
MYSQL_CONN_URL = f"mysql+mysqlconnector://ndadmin:{pw}@localhost:3306/centricityps_original_16oct"

DIFF_DB = "CentricityPS_differences"

# Global defaults (per-table values can override)
DEFAULT_CHUNK_SIZE = 200_000          # range size per numeric PK chunk
...
ONLY_TABLES = ['CMSReimbursementMap']
...
def choose_table_settings(table, row_count):
    ...
    if t == "ALLERGY":
        chunk_size = 50_000
        max_workers = 1    # sequential chunks
